...
export const createTaskRequest = (token, payload) =>
  request("/tasks", {
    method: "POST",
    headers: { Authorization: `Bearer ${token}` },
    body: JSON.stringify(payload),
  });
export const updateTaskRequest = (token, id, payload) =>
  request(`/tasks/${id}`, {
    method: "PUT",
    headers: { Authorization: `Bearer ${token}` },
    body: JSON.stringify(payload),
...
export const createAuditRequest = (token, payload) =>
  request("/audits", {
    method: "POST",
    headers: { Authorization: `Bearer ${token}` },
    body: JSON.stringify(payload),
...
export const createIdeaRequest = (token, payload) =>
  request("/ideas", {
    method: "POST",
    headers: { Authorization: `Bearer ${token}` },
    body: JSON.stringify(payload),
  });
export const voteIdeaRequest = (token, ideaId) =>
  request(`/ideas/vote/${ideaId}`, { method: "POST", headers: { Authorization: `Bearer ${token}` } });
